...
<body>
			...
			<center><div class=" course">
					<form method="post">
					<center>
						<input type="submit"  name="click" value="CSE 1100"></br>
						<input type="submit"  name="click" value="CSE 1101"></br>
						<input type="submit"  name="click" value="EEE 1151"></br>
						<input type="submit"  name="click" value="MATH 1113"></br>
						<input type="submit"  name="click" value="HUM 1113"></br>
						<input type="submit"  name="click" value="CHEM 1113"></br>
