...
<body>
			...
			<center><div class=" course">
					<form method="post">
					<center>
						<input type="submit"  name="click" value="CSE 1200"></br>
						<input type="submit"  name="click" value="CSE 1201"></br>
						<input type="submit"  name="click" value="CSE 1203"></br>
						<input type="submit"  name="click" value="MATH 1213"></br>
						<input type="submit"  name="click" value="HUM 1213"></br>
						<input type="submit"  name="click" value="PHY 1213"></br>
