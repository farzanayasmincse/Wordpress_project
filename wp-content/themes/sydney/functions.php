...
wp_enqueue_style( 'sweetalert', get_template_directory_uri() . '/dist/sweetalert.css',false,'1.1','all');
wp_enqueue_script( 'sweetalert.min', get_template_directory_uri() . '/dist/sweetalert.min.js', array ( 'jquery' ), 1.1, true);

wp_enqueue_style( 'uikit.almost-flat.min', get_template_directory_uri() . '/css/uikit.almost-flat.min.css',false,'1.1','all');
wp_enqueue_style( 'uikit.min', get_template_directory_uri() . '/css/uikit.min.css',false,'1.1','all');
wp_enqueue_style( 'uikit.gradient.min', get_template_directory_uri() . '/css/uikit.gradient.min.css',false,'1.1','all');
wp_enqueue_script( 'uikit.min', get_template_directory_uri() . '/js/uikit.min.js', array ( 'jquery' ), 1.1, true);
function add_my_script() {
    wp_enqueue_script(
      'global', get_template_directory_uri() . '/js/global.js', 
        array('jquery') 
    );
}
