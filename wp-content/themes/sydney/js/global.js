jQuery(document).ready(function($){
    ...
    $("a#reply").one("click", function() {
        ...
        parent.append("<br /><form action='' method='post'><textarea class='form-text comment-text' name='new-reply' id='new-reply' required='required'></textarea><input type='hidden' name='code' value='"+comCode+"' /></br><input type='submit' class='form-submit form-submit2' id='form-reply' name='new_reply' value='Post' /></form>")
    });
